...
public:
    ...
    void setupUi(QDialog *AdminMenu)
    {
        ...
        widget->setGeometry(QRect(240, 170, 301, 103));
        verticalLayout = new QVBoxLayout(widget);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        pushButton_1_BazaUzytkownikow = new QPushButton(widget);
        ...
        pushButton_2_BazaSamochodow = new QPushButton(widget);
        ...
        pushButton_3_AktualneRezerwacje = new QPushButton(widget);
